...
var task_card_string =
  '<div class="status-icon"></div><p class="task-text"><p class="task-status color-red">Not-started</p><ion-icon class="delete fs-large mg-10" name="close-circle-outline"></ion-icon>';
var task_count = 5;
updateTaskCount();
eventSetter();
